...
export function SiteFooter() {
  ...
  return (
    <footer
      id="visit"
      className="border-t border-sanctuary-stone bg-sanctuary-alabaster px-6 py-20 md:px-8 md:py-24"
    >
      <div className="mx-auto max-w-7xl">
        <div className="mb-16 text-center">
          <span className="eyebrow mb-3">The next step is a conversation</span>
          ...
          <ConsultationButton className="px-8 py-4">Request a consultation</ConsultationButton>
        </div>
        ...
        <div className="grid grid-cols-1 gap-10 border-t border-sanctuary-stone pt-12 font-sans text-sm sm:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <p className="text-xs uppercase tracking-widest text-sanctuary-gold-deep">
              {clinic.credentialsLine}
            </p>
          </div>

          <div>
            <h4 className="mb-3 text-xs uppercase tracking-widest text-sanctuary-muted">Visit</h4>
            ...
            <a
              ...
              className="mt-2 inline-block text-xs uppercase tracking-widest text-sanctuary-gold-deep underline decoration-sanctuary-gold/40 underline-offset-4"
            >
              Directions
            </a>
          </div>
          ...
          <div>
            <h4 className="mb-3 text-xs uppercase tracking-widest text-sanctuary-muted">Contact</h4>
            <ul className="space-y-2 text-sanctuary-charcoal">
              <li>
                <a className="hover:text-sanctuary-gold-deep" href={'tel:' + clinic.phone.dial}>
                  {clinic.phone.display}
                </a>
              </li>
              <li>
                <a className="hover:text-sanctuary-gold-deep" href={'mailto:' + clinic.email}>
                  {clinic.email}
                </a>
              </li>
              {clinic.social.map((channel) => (
                <li key={channel.id}>
                  <a
                    className="hover:text-sanctuary-gold-deep"
                    href={channel.href}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
          ...
          <div>
            <h4 className="mb-3 text-xs uppercase tracking-widest text-sanctuary-muted">Hours</h4>
