...
export const enquiryMessage = {
  ...
  concern: (concern: string) => `Hello Allure Passions UK, I would like to discuss ${concern} and which treatments may help.`,
  treatment: (treatment: string) => `Hello Allure Passions UK, I would like to enquire about ${treatment}.`,
  programme: (programme: string) => `Hello Allure Passions UK, I would like to enquire about the ${programme} programme.`,
};
