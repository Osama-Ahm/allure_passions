...
export const stage = {
  ...
  planFrom: [new THREE.Vector3(), new THREE.Vector3(), new THREE.Vector3(), new THREE.Vector3()],
};
 ...
 */
export const ORDER = { director: -7, bottle: -6, droplets: -5, crystal: -4, energies: -3, arch: -2, tokens: -1 } as const;
