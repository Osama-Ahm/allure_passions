...
export const trustDossier = [
  ...
  },
  {
    ...
    proof: [{ label: 'Practitioner-led' }, ...(import.meta.env.DEV ? [{ label: 'Name & portrait: client to supply', pending: true }] : [])],
  },
  {
    id: 'level6',
    badge: 'L6',
    ...
    proof: [{ label: 'Level 6 aesthetic practice' }, ...(import.meta.env.DEV ? [{ label: 'Awarding body: to confirm', pending: true }] : [])],
  },
  {
    id: 'technology',
    badge: '◎',
  ...
  },
  {
    ...
    proof: [{ label: 'Consultation first' }, { label: 'Written aftercare' }, ...(import.meta.env.DEV ? [{ label: 'Membership names: to confirm', pending: true }] : [])],
  },
];
...
export const memberships = [
  ...
  ...(import.meta.env.DEV ? [{ id: 'membership-1', pending: true }, { id: 'membership-2', pending: true }] : []),
];
